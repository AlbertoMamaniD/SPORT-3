...
public class AdminController {
    ...
    private List<bo.ucb.sport.interfaces.dto.response.ReservaAdminResponse> getReservasAdmin() {
        return reservaRepository.findAll().stream()
                .map(r -> {
                    ...
                    String estadoPago = r.getEstado() == bo.ucb.sport.domain.model.reserva.EstadoReserva.CONFIRMADA ? "COMPLETADO" : (r.getEstado() == bo.ucb.sport.domain.model.reserva.EstadoReserva.CANCELADA ? "CANCELADA" : "PENDIENTE");
    ...
    public ResponseEntity<Void> cancelarReservaAdmin(@PathVariable Long id, @AuthenticationPrincipal Long usuarioId) {
    ...
    public ResponseEntity<List<bo.ucb.sport.interfaces.dto.response.PrecioResponse>> listarPrecios() {
        List<bo.ucb.sport.interfaces.dto.response.PrecioResponse> res = precioRepository.findAllVigentes().stream()
